...
import { ChatServiceHealthController, ChatServiceHealthService } from './health.controller';
import { ServiceUnavailableException } from '@nestjs/common';

describe('ChatServiceHealthController', () => {
  let controller: ChatServiceHealthController;
  let healthService: ChatServiceHealthService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      controllers: [ChatServiceHealthController],
      providers: [ChatServiceHealthService],
    }).compile();

    controller = module.get<ChatServiceHealthController>(ChatServiceHealthController);
    healthService = module.get<ChatServiceHealthService>(ChatServiceHealthService);
  });
  ...
  describe('getServiceName', () => {
    it('should return the correct service name', () => {
      ...
      expect((controller as any).getServiceName()).toBe('chat-service');
    });
  });
...
describe('ChatServiceHealthService', () => {
